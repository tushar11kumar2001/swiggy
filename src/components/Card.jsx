...
const Card = ({ restData, login }) => {
  ...
  const { name, cuisines, cloudinaryImageId, avgRatingString,sla } =
    restData.info;
  return (
    <div className="h-72 flex flex-col justify-evenly w-64 bg-white   font-Comforter hover:scale-95 shadow-sm rounded-lg ">
      ...
      <h2 className="text-wrap">{cuisines.join(", ")}</h2>
